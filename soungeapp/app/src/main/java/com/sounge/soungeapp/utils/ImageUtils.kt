...
object ImageUtils {
    fun popupImage(drawable: Drawable, location: View) {
        val popupBinding = PopupFullscreenMediaBinding.inflate(LayoutInflater.from(location.context))
        val imageView = popupBinding.ivFullscreenImage
        imageView.setImageDrawable(drawable)
        val closeButton = popupBinding.ivCloseButton

        val builder = PopupWindow(popupBinding.root, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, true)
