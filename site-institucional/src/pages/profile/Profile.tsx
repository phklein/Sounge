  ...
  const convertImageToByteArray = (image: any) => {
    ...
    reader.onload = (e) => {
      ...
      reader.onload = () => {
        ...
        UserRoute.updateSimplePicture(id, request)
          .then((res) => {
            if (res.status === 200) {
          ...
          <div className="profile-container">
            ...
            <div className="profile-details">
              <div
                ...
                style={{ backgroundImage: `url(${userProfile?.profilePic})` }}
              >
          ...
          <div className="test">
            <div className="background-intro">
              ...
              {userProfile?.roles.map((skill) => (
                <PageIntroduction key={skill.id} name={skill.name} />
              ))}
            </div>
