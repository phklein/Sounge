                  ...
                  <Form.Group controlId="formGroupGenres">
                        <div className="dropdown">
                          ...
                          <div className="submenu">
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.ROCK)}>Rock</div>
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.POP)}>Pop</div>
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.PAGODE)}>Pagode</div>
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.SERTANEJO)}>Sertanejo</div>
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.METAL)}>Metal</div>
                            <div className="item" onClick={(event) => handleAddFromListChangeGenre(GenreNameEnum.INDIE)}>Indie</div>
                          </div>
