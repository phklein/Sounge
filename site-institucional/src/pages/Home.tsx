...
const cardStyles = {
  publicationStyle1: {
    background: `url(${PubOne})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
  },
  publicationStyle2: {
    background: `url(${PubTwo})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
  },
  publicationStyle3: {
    background: `url(${PubThree})`,
    backgroundSize: "cover",
    backgroundPosition: "center",
  },
};
  ...
  return (
    <div className="page-init">
      ...
      <section className="banner">
        <h1>
          “Tocar uma nota equivocada é insignificante.
          <br />
        ...
        <div className="container">
          <div className="presentation-container">
            <div className="presentation-item">
              ...
              <h1>Compartilhe</h1>
              <h2>
                Divulgue o seu trabalho e alcance a oportunidade que tanto
                almeja!
              </h2>
              <h2>
                Divulgue o seu trabalho e alcance a oportunidade que tanto
      ...
      <section className="player">
        <h1>
          Compartilhe <span>seu som!</span>
        </h1>
        <iframe
          className="containerSpotify"
          src="https://open.spotify.com/embed/playlist/2M2aj5IeLoaNlu4wgNxvcH?utm_source=generator"
          width="100%"
          height="100%"
          frameBorder="0"
      ...
      <section className="publications">
        ...
        <div className="container publications-list">
          <div
            ...
            style={cardStyles.publicationStyle1}
          ></div>
          <div
            className="publication-item"
            style={cardStyles.publicationStyle2}
          ></div>
          <div
            className="publication-item"
            style={cardStyles.publicationStyle3}
          ></div>
        </div>
      </section>
      <Footer />
